...
<div class="container">
  ...
  <div class="card">
    ...
    <p style="color:#9ca3af;margin:-8px 0 16px;font-size:13px;">
      Human-in-the-loop decisions via <code>POST /api/approvals/:id</code>
    </p>
    <table>
      <thead>
        <tr>
  ...
  <div class="card">
    ...
    <p style="color:#9ca3af;margin:-8px 0 16px;font-size:13px;">
      Speculative samples and concept briefs — API: <code>/api/samples</code>
    </p>
    <table>
      <thead>
        <tr>
      ...
      <tbody>
        ${sampleRows || `
        <tr>
          <td colspan="6">No samples yet.</td>
        </tr>`}
      </tbody>
    </table>
  ...
  <div class="card">
    ...
    <p style="color:#9ca3af;margin:-8px 0 16px;font-size:13px;">
      Drafted proposals — API: <code>/api/proposals</code>
    </p>
    <table>
      <thead>
        <tr>
      ...
      <tbody>
        ${proposalRows || `
        <tr>
          <td colspan="5">No proposals yet.</td>
        </tr>`}
      </tbody>
    </table>
